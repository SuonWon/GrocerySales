               ...
               <div class="col-12 col-lg-6">
                    ...
                    <div class="row">
                         ...
                         <div class="col-6 mb-3">
                              ...
                              <input type="number" class="form-control cust-input-box" id="unitPrice" name="UnitPrice" value="{{$item->UnitPrice ? number_format($item->UnitPrice) : 0}}" onfocus="AutoSelectValue(event)" onblur="CheckNumber(event)" required>
                              <div class="invalid-feedback">
                    ...
                    <div class="row">
                         ...
                         <div class="col-6 mb-3">
                              ...
                              <input type="number" class="form-control cust-input-box" id="weightByPrice" name="WeightByPrice" value="{{$item->WeightByPrice ? number_format($item->WeightByPrice) : 1}}" required>
                              <div class="invalid-feedback">
                         ...
                         <div class="col-6 mb-3">
                              ...
                              <input type="number" class="form-control cust-input-box" id="lastPurchaseUnit" name="LastPurPrice" value="{{$item->LastPurPrice ? number_format($item->LastPurPrice) : 0}}" onfocus="AutoSelectValue(event)" onblur="CheckNumber(event)" required>
                              <div class="invalid-feedback">
