    ...
    <div class="container-fluid content-body mt-3">
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-8 col-md-6 p-0">
                <h3 class="section-title">Create Stock Adjustment</h3>
            </div>
            {{-- Back Button --}}
        ...
        <form action="/stockadjustment/add" method="Post" id="saveAdjustData"
            ...
            <div class="col-12 px-0">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-xl-4 col-xxl-2 mb-2">
                        <label for="adjustmentDate" class="form-label cust-label">Transfer Date</label>
                        <input type="date" class="form-control cust-input-box" id="adjustmentDate" name="AdjustmentDate"
                    ...
                    <div class="col-12 col-md-6 col-xl-4 col-xxl-3 mb-2">
                        <label for="adjustmentWarehouse" class="form-label cust-label">Warehouse</label>
                    ...
                    <div class="col-12 col-md-6 col-xl-4 col-xxl-4 mb-2">
                        ...
                        <textarea class="form-control cust-textarea" name="" id="adjustmentRemark" rows="2"></textarea>
                    </div>
                </div>
                ...
                <div class="row mt-2">
                    <div class="col-12 text-end">
                        ...
                        <button type="button" class="btn btn-primary me-2" id="printAdjBtn">
...
<script>
    ...
    $(document).ready(function() {
        ...
        dselect(document.querySelector(".adjustType_" + lineNo), {search: false, maxHeight: '150px'});
            ...
            if (e.LineNo == rowNo) {
                ...
                itemList.forEach(el => {
                    ...
                    if (e.ItemCode == el.itemId) {
                        ...
                        TableRowReplace(rowNo, e.ItemCode, e.ItemName, e.Quantity, e.PackedUnit, e.UnitName, e.QtyPerUnit, e.TotalViss, e.UnitPrice, e.Amount, e.AdjustType);
    ...
    function TableRowReplace(refNo, ItemCode, ItemName, Quantity, PackedUnit, UnitName, QtyPerUnit, TotalViss, UnitPrice, Amount, AdjustType) {
        ...
        dselect(document.querySelector(".adjustType_" + refNo), {search: false, maxHeight: '150px'});
    ...
    $("#saveAdjustData").submit(SaveAdjustData);

    function SaveAdjustData(event) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.message == "good") {
                    ...
                    window.location.href='/stockadjustment/add';
