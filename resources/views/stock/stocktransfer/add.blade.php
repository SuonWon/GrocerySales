<x-layout title="Create Stock Transfer">
    ...
    <div class="container-fluid content-body mt-3">
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-8 col-md-6 p-0">
                <h3 class="section-title">Create Stock Transfer</h3>
            </div>
            {{-- Back Button --}}
            ...
            <div class="col-12 px-0">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-xl-4 col-xxl-2 mb-2">
                        ...
                        <input type="date" class="form-control cust-input-box" id="transferDate" name="TransferDate"
                    ...
                    <div class="col-12 col-md-6 col-xl-4 col-xxl-4 mb-2">
                        ...
                        <textarea class="form-control cust-textarea" name="" id="transferRemark" rows="2"></textarea>
                    </div>
                </div>
