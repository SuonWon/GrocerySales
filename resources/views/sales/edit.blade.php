<x-layout title="Edit Sales">
    ...
    {{-- Form Section --}}
        ...
        <form action="/salesinvoices/update/{{$saleinvoice->InvoiceNo}}" method="Post" id="updateSalesForm" class="row form-card mt-2 mb-3 needs-validation" novalidate>
            @csrf
            <div class="col-12 px-0">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-xl-4 col-xxl-2 mb-2">
                        ...
                        <input type="text" class="form-control cust-input-box" id="saleInvoiceNo" name="InvoiceNo" value="{{$saleinvoice->InvoiceNo}}" disabled>
                    </div>
                    {{-- Sale Date --}}
                    <div class="col-12 col-md-6 col-xl-4 col-xxl-2 mb-2">
                        <label for="saleDate" class="form-label cust-label">Sales Date</label>
                        <input type="date" class="form-control cust-input-box" id="saleDate" name="SaleDate" value="{{$saleinvoice->SalesDate}}" required>
                    </div>
                            ...
                            @if(isset($customers) && is_object($customers) && count($customers) > 0)
                                @forelse ($customers as $customer)
                                    ...
                                    @if ($customer->CustomerCode == $saleinvoice->CustomerCode)
                                            <option value="{{$customer->CustomerCode}}" selected >{{$customer->CustomerName}}</option>
                                        @else
                    ...
                    <div class="col-12 col-md-6 col-xl-4 col-xxl-2 mb-2">
                        ...
                        <input type="text" class="form-control cust-input-box" id="salePlateNo" name="PlateNo" value="{{$saleinvoice->PlateNo}}">
                    ...
                    <div class="col-md-8 col-xl-7 col-xxl-6">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-xl-5 col-xxl-4 mb-2">
                                ...
                                <input type="date" class="form-control cust-input-box" id="salePaidDate" name="PaidDate" value="{{$saleinvoice->PaidDate}}" {{$saleinvoice->IsPaid == 1 ? "" : "disabled"}}>
                            </div>
                            {{-- Paid Status --}}
                            <div class="col-12 col-md-6 col-xl-4 col-xxl-3 mb-2">
                                ...
                                <div class="col-sm-8 form-check form-switch">
                                    <input class="form-check-input cust-form-switch" type="checkbox" role="switch" id="saleIsPaid" name="IsPaid" {{$saleinvoice->IsPaid == 1 ? "checked" : ""}} onchange="SEPaidCheck(event)">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody id="selectedSalesItems">
                                @foreach ( $saleinvoice->saleinvoicedetails  as $key => $saleinvoicedetail )
                                    <tr id="{{$key + 1}}">
                                        ...
                                        <td class="px-0 py-0">
                                            <select name="" id="{{$key + 1}}" class="saleWhList_{{$key + 1}}" onchange="AddSaleWh(this.id, this.value);">
                                        ...
                                        <td class="px-0 py-0">
                                            <input type="text" class="text-end" name="" value="{{number_format($saleinvoicedetail->Quantity)}}" id="{{$key + 1}}" nextfocus="saleprice_{{$key + 1}}" onblur="AddSaleQty(event,this.id,this.value);" onfocus="FocusValue(event);">
                                        </td>
                                        <td class="px-0 py-0">
                                            <select name="" class="saleUnitList_{{$key + 1}}" id="{{$key + 1}}" onchange="AddSaleUnit(this.id, this.value);">
                                        ...
                                        <td class="px-0 py-0">
                                            <input type="number" class="tableInput" name="" id="{{$key + 1}}" onblur="AddSaleDisRate(this.id, this.value);" value="{{$saleinvoicedetail->LineDisPer}}" onfocus="FocusValue(event);">
                                        </td>
                                        <td class="px-0 py-0">
                                        ...
                                        <td class="px-2 py-0">
                                            <button type="button" id="{{$key + 1}}" class="btn delete-btn py-0 mt-1 px-1" onclick="DeleteSalesRow(this.id)">
                ...
                <div class="row mt-3 justify-content-between">
                    <div class="col-xl-5 col-xxl-4">
                        ...
                        <div class="row justify-content-end">
                            <label for="SELaborCharges" class="form-label text-end cust-label col-5">Labor Charges :</label>
                            <div class="col-5 col-xxl-6 mb-2">
                                <input type="text" class="form-control cust-input-box text-end" id="SELaborCharges" name="LaborCharges" value="{{number_format($saleinvoice->LaborCharges)}}" onblur="SaleCharges(event);">
                            </div>
                        </div>
                        {{-- Delivery Charges --}}
                        <div class="row justify-content-end">
                            <label for="SEDeliveryCharges" class="form-label text-end cust-label col-5">Delivery Charges :</label>
                            <div class="col-5 col-xxl-6 mb-2">
                                <input type="text" class="form-control cust-input-box text-end" id="SEDeliveryCharges" name="DeliveryCharges" value="{{number_format($saleinvoice->DeliveryCharges)}}" onblur="SaleCharges(event);">
                            </div>
                        </div>
                        {{-- Weight Charges --}}
                        <div class="row justify-content-end">
                            <label for="SEWeightCharges" class="form-label text-end cust-label col-5">Weight Charges :</label>
                            <div class="col-5 col-xxl-6 mb-2">
                                <input type="text" class="form-control cust-input-box text-end" id="SEWeightCharges" name="WeightCharges" value="{{number_format($saleinvoice->WeightCharges)}}" onblur="SaleCharges(event);">
                            </div>
                        </div>
                        {{-- Service Charges --}}
                        <div class="row justify-content-end">
                            <label for="SEServiceCharges" class="form-label text-end cust-label col-5">Service Charges :</label>
                            <div class="col-5 col-xxl-6 mb-2">
                                <input type="text" class="form-control cust-input-box text-end" id="SEServiceCharges" name="ServiceCharges" value="{{number_format($saleinvoice->ServiceCharges)}}" onblur="SaleCharges(event);">
                            </div>
                        </div>
                        <hr>
                    </div>
                    <div class="col-xl-6">
                        ...
                        <div class="row justify-content-end mt-2">
                            ...
                            <div class="col-5 col-xl-5 col-xxl-4 mb-2">
                                <input type="text" class="form-control cust-input-box text-end" id="saleSubTotal" name="SubTotal" value="{{number_format($saleinvoice->SubTotal)}}" disabled>
                            </div>
                        </div>
                        {{-- Total Charges --}}
                        <div class="row justify-content-end">
                            ...
                            <div class="col-5 col-xl-5 col-xxl-4 mb-2">
                                <input type="text" class="form-control cust-input-box text-end" id="saleTotalCharges" name="TotalCharges" value="{{number_format($saleinvoice->TotalCharges)}}" disabled>
                            </div>
                        </div>
                        {{-- Grand Total --}}
                        <div class="row justify-content-end">
                            ...
                            <div class="col-5 col-xl-5 col-xxl-4 mb-2">
                                <input type="text" class="form-control cust-input-box text-end" id="saleGrandTotal" name="GrandTotal" value="{{number_format($saleinvoice->GrandTotal)}}" disabled>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-2">
                    <div class="col-12 text-end">
                        ...
                        <button type="button" class="btn delete-btn" id="{{$saleinvoice->InvoiceNo}}" onclick="PassSaleInNo(this.id);" data-bs-toggle="modal" data-bs-target="#saleDeleteModal">
...
<script>
    ...
    $("#addNewProd").on("click", ()=>{
        ...
        newRow.innerHTML = `
                            ...
                            <td class="px-0 py-0">
                                <input type="text" class="saleprice_`+ saleRowNo +` text-end" value="0" id="`+ saleRowNo +`" onblur="AddSalePrice(event,this.id,this.value);" nextfocus="viss_`+ saleRowNo +`" onfocus="FocusValue(event);">
                            </td>
                            <td class="px-0 py-0">
                                <input type="number" class="viss_`+ saleRowNo +` text-end" value="1" id="`+ saleRowNo +`" onblur="AddSaleTotalViss(this.id,this.value)" onfocus="FocusVale(event);">
                            </td>
                            <td class="px-0 py-0">
        ...
        for(let i = 0; i < noRow; i++) {
            ...
            if( rowId == refNo) {
                ...
                mainTable.rows[i].innerHTML = `
                                    ...
                                    <td class="px-0 py-0">
                                        <input type="text" class="text-end" id="`+ refNo +`" value="`+ LineDisAmt.toLocaleString() +`" onblur="AddSaleDisAmt(this.id, this.value);"`+ checkDisAmt +` onfocus="FocusValue(event);">
                                    </td>
                                    <td class="px-0 py-0">
